...
// Load session library
        ...
        echo'<a href="'.site_url('Home/auth').'">Login/SignUp</a>';
...
// Load session library
      ...
      if($name)
           {               echo'
                        <li>
                        <div class="top-dropdown" style="float: left !important;">
    <span class="ab" style="margin-right:40px;">Hi,'.$name.'<i class="icon fa-angle-down"></i></span>
  <div class="dropdown-content" id="down">
    <a href="#">Dashboard</a>
    <a href="#">Profile</a>
    <a href="#">Change Password</a>
    <a href="'.site_url('Auth/logout').'">Logout</a>
        ...
        echo'<li class="padd">
        <a href="'.site_url('Home/auth').'" class="button special small 1">Login/SignUp</a>
        </li>';
...
<!--End of Tawk.to Script--> <script type="text/javascript" src="//code.jquery.com/jquery-1.11.0.min.js"></script>
