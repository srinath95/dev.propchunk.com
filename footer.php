    ...
    <div class="row col-lg-8 col-md-12 col-sm-12 col-xs-12 " >
         <div class="input-group">
                                ...
                                <span class="input-group-addon border-for-icons"><span class="glyphicon glyphicon-envelope"></span>
                                </span>
    ...
    <address class="text-left;">
                  <h5 id="text-left1">Company</h5>
                      <ul class="list-group text-left">
                            <li class="list-group-item le text-left" id="le" ><a href="<?php echo site_url('Home/about_us');?>">    About</a></li>
                                                 </ul>   
                </address>                  
...
<div class="row col-lg-2 col-md-3 col-sm-4 col-xs-12">
    <address class="text-left;">
                  <h5 id="text-left1">Learn</h5>
                        <ul class="list-group le text-left">
                            <li class="list-group-item le text-left" id="le"><a href="#"> How it works</a></li>
                            <li class="list-group-item le text-left" id="le"><a href="<?php echo site_url('Home/faq');?>" >FAQ's</a></li>
